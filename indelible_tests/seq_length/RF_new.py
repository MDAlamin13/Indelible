...
for folder in range(100,801,100):
    ...
    dir_pathm="/mnt/e/PhD_Study/FromLinux/PhD_Study/Research/Simulated_Datasets/Indelible/indelible_tests/seq_length/"+dir_name
    dir_path ="/mnt/e/PhD_Study/FromLinux/PhD_Study/Research/Simulated_Datasets/Indelible/indelible_tests/hpcc_run/simulation/seq_length/"+dir_name
